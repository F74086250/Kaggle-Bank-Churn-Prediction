...
def test(Var_name = "show_all",Srand_s=29,Srand_e=29,Tree_num_s=100,Tree_num_e=100,Features=10):
    ...
    for i in range(Srand_s,Srand_e+1):
        for j in range(Tree_num_s,Tree_num_e+1):
            ...
            classifier = RandomForestClassifier(n_estimators=j, oob_score=True, max_features=Features)
