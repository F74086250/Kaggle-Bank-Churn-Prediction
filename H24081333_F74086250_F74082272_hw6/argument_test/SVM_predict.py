...
def test(Var_name = "show_all",Srand_s = 29,Srand_e = 29,gamma_s = 0.057,gamma_e = 0.057):
    ...
    if optimal:
        ...
        gamma_s,gamma_e = Optimal_Var2,Optimal_Var2
    for i in range(Srand_s,Srand_e+1):
        for j in range(int(gamma_s*1000),int(gamma_e*1000)+1):
            ...
            clf = svm.SVC(kernel='rbf', gamma=j/1000)
            ...
            if self_testing:
                ...
                Total = (Srand_e-Srand_s+1)*(gamma_e*1000-gamma_s*1000+1)
                progress =  (i-Srand_s)*(gamma_e*1000-gamma_s*1000+1)+(j-gamma_s*1000)
...
def self_optimizing(v1=69,v2=300,v3=0.233,v4=0.233,Apply = True):
